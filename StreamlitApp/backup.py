...
weightsPath = "C:/darknet/darknet-master/build/darknet/x64/yolov4-tiny.weights"
...
if st.button('Start'):
    ...
    if option == "Demo1":
        ...
        vs = cv2.VideoCapture("divisoria.mp4")
    else:
    ...
    while True:
        ...
        frame = cv2.putText(frame, datet, (0, 35), font, 1, (0, 255, 255), 2, cv2.LINE_AA)
